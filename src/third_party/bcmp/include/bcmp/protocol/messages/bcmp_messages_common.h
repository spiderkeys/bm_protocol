#ifndef BCMP_PROTOCOL_MESSAGES_BCMP_MESSAGES_COMMON_H
#define BCMP_PROTOCOL_MESSAGES_BCMP_MESSAGES_COMMON_H
...
#endif /*BCMP_PROTOCOL_MESSAGES_BCMP_MESSAGES_COMMON_H*/